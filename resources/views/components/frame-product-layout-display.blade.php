    ...
    <div class="container px-0">
        <div class="bg-white box-p rounded-3 frame-product-layout-display">
            ...
            <div class="d-sm-none d-flex gap-2 align-items-center">
                <div>
                    <img src="https://cdn.kidsplaza.io/assets/icons/diaper.png" width="32" height="32" alt="logo" />
                </div>
            ...
            <div class="d-xs-none row box-m-top-bottom gap-3 frame-product-layout-display-banner overflow-hidden">
                ...
                <div class="{{$item['col']}} px-0 col-xs-11">
                    <img class="rounded-4" src="{{ asset($item['src']) }}" alt="img" width="100%" height="230">
                </div>
                @endforeach
            </div>
            <div class="d-sm-none box-m-top-bottom frame-product-layout-display-banner-owl-carousel owl-carousel owl-theme">
                @foreach($banner as $item)
                <div class="item">
                    <img class="rounded-4" src="{{ asset($item['src']) }}" alt="img" width="100%" height="230">
                </div>
            ...
            <div class="row box-m-top-bottom d-flex align-items-center border-top border-bottom frame-product-layout-display-properties py-4">
            ...
            <div class="box-m-top-bottom frame-product-layout-display-brand">
                <div class="row justify-content-between flex-nowrap frame-product-layout-owl-carousel owl-carousel owl-theme">
                    @foreach([
                    'https://cdn-v2.kidsplaza.vn/media/amasty/shopby/option_images/huggies_1.png',
                    'https://cdn-v2.kidsplaza.vn/media/amasty/shopby/option_images/slider/bobby-logo-.jpg',
                    'https://cdn-v2.kidsplaza.vn/media/amasty/shopby/option_images/slider/logo-goldgi.jpg',
                    'https://cdn-v2.kidsplaza.vn/media/amasty/shopby/option_images/slider/molfix.jpg',
        
                    ] as $item)
                    <div class="item "><!-- col-xl-1 col-lg-2 col-xs-3 -->
                        <img class="p-2" style="border-radius:50%;" src="{{ $item }}" alt="" width="100" height="100" />
                    </div>
                    @endforeach
                </div>
                <div class="d-xs-none">
            ...
            <div class="">
                ...
                <div class="w-100 ">
                    <x-button class="d-flex mx-auto bg-bule23-hover border gap-1 align-items-center text-white bg-bule204 list-product-view-all rounded-5 px-4 py-2 fw-semibold" text="Xem tất cả" icon="bi bi-chevron-right" iconPosition="right" />
                </div>
            </div>
        </div>
    </div>
